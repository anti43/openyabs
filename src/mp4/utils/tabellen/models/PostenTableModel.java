...
public class PostenTableModel extends MPTableModel {
    ...
    public PostenTableModel(){
        super(new Class[]{java.lang.Integer.class, java.lang.Double.class,
                ...
                }, new boolean[]{true,true,true,true,true,true},new Object[][]{{null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null},
                    {null, 1, null, FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null}, {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null},
                    {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null}, {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null},
                    {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null}, {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null},
                    {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null}, {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null},
                    {null, 1, null,FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), null, null}
                },
    ...
    public void addProduct(JTable table, Product product){
        ...
        try {
            ...
            try {
                ...
                m.setValueAt(FormatNumber.formatDezimal(Einstellungen.instanceOf().getGlobaltax()), selectedRow, 3);
            }
            try {
