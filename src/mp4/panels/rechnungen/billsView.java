...
public class billsView extends mp4.items.visual.CommonPanel implements DataPanel, mp4.datenbank.installation.Tabellen {
    ...
    public billsView(mainframe frame) {
        ...
        jCheckBox4.setSelected(Programmdaten.instanceOf().getBILLPANEL_CHECKBOX_MITLIEFERSCHEIN_state());
    ...
    public void addMahnung() {
 
        jTextField10.setText(String.valueOf(currentBill.getMahnungen() + 1));
        currentBill.setMahnungen(currentBill.getMahnungen() + 1);
    }
...
//                this.setBill(new Rechnung());
    ...
    public void setBill(Rechnung current) {
        ...
        if (current.getRechnungnummer() != null) {
            this.changeTabText("Rechnung: " + current.getRechnungnummer());
        } else {
            this.changeTabText("Rechnung: (neu)");
        }
    ...
    private void initComponents() {
        ...
        jButton6.setText(bundle.getString("billsView.jButton6.text")); // NOI18N
        ...
        jCheckBox6.setBackground(new java.awt.Color(227, 219, 202));
        jCheckBox6.setSelected(true);
        jCheckBox6.setText(bundle.getString("billsView.jCheckBox6.text")); // NOI18N
        jCheckBox6.setToolTipText(bundle.getString("billsView.jCheckBox6.toolTipText")); // NOI18N
        ...
        ampel_offen.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        ampel_bezahlt.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        ampel_verzug.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        jButton21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bilder/small/fileclose.png"))); // NOI18N
        jButton21.setText(bundle.getString("billsView.jButton21.text")); // NOI18N
        jButton21.setToolTipText(bundle.getString("billsView.jButton21.toolTipText")); // NOI18N
...
private void jCheckBox6ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox6ItemStateChanged
    ...
    Programmdaten.instanceOf().setBILLPANEL_CHECKBOX_MITFIRMENNAME(jCheckBox6.isSelected());
