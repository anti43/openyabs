 ...
 * @author  Andreas
 */
public class ANumberFormatEditor extends javax.swing.JFrame {
...
//    }
    ...
    public ANumberFormatEditor(Countable mode) {
        initComponents();
        this.mode = mode;
        new Position(this);
        this.setVisible(rootPaneCheckingEnabled);
        try {
            String[] str = Programmdaten.instanceOf().getANGEBOT_NUMMER_FORMAT().split("&!");
