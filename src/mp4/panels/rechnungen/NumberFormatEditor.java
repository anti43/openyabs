...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    nfh.test(jTextField1.getText() + "&!" + jComboBox1.getSelectedIndex());
    mode.setNumberFormatHandler(nfh);


    try {
        jTextField2.setText(mode.getNfh().getNextNumber());
    } catch (Exception e) {
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
    ...
    try {
       formatString = mode.getNfh().getNextNumber();
       mode.getNfh().save(fstring);
       this.dispose();
    } catch (Exception e) {
        Log.Debug(e, rootPaneCheckingEnabled);
        Popup.notice("Format nicht möglich.");
