...
public class servicesView extends mp4.items.visual.CommonPanel implements mp4.datenbank.installation.Tabellen, DataPanel{
    ...
    public servicesView(mainframe frame) {
        ...
        Locale.setDefault(new Locale("de", "DE", Programmdaten.instanceOf().getSERVICEPANEL_MASK()));
    ...
    private void fillSearchTable() {
        String[][] list = current.select("id,produktnummer,name", null, null, "produktnummer ASC ", false);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar2, javax.swing.GroupLayout.DEFAULT_SIZE, 731, Short.MAX_VALUE)
        );
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addComponent(jTextField12, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTextField2ActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
        ...
        String k = "id, " + "Nummer,Name";
        try {
            String[][] list = current.select("id,produktnummer,name", "name", jTextField2.getText(), "name", true, false, false);
...
private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
    ...
    private boolean createNew() {
        ...
        service.setName(jTextField5.getText());
        service.setPreis(Double.valueOf(jTextField8.getText()));
        service.setTaxID(taxID);
        service.setDatum(DateConverter.getDate(jTextField9.getText()));
        service.setEinheit(jTextField10.getText());
        service.setDatum(DateConverter.getDate(jTextField9.getText()));
        service.setBeschreibung(jEditorPane1.getText());
    ...
    public void save() {
        if (current.getId() > 0) {
            ...
            current.setEinheit(jTextField10.getText());
