...
public class eurEPanel extends mp4.items.visual.CommonPanel {
    ...
    public eurEPanel() {
        ...
        curKonto = Einstellungen.instanceOf().getEinnahmen_Standard_Konto();

        jTextField6.setText(DateConverter.getTodayDefDate());
        jTextField3.setText(FormatNumber.formatDezimal(Einstellungen.instanceOf().getHauptsteuersatz()));
        jTextField4.setText("0");
        jTextField5.setText(Einstellungen.instanceOf().getEinnahmen_Standard_Konto().getArt());
...
//        jTextField4.setInputVerifier(InputVerifiers.getDoubleInputVerfier(jTextField4));
    ...
    private void initComponents() {
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bilder/3232/edittrash.png"))); // NOI18N
        jButton5.setToolTipText("Löschen");
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bilder/3232/new_window.png"))); // NOI18N
        jButton4.setToolTipText("Als neue Einnahme");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bilder/3232/filesave.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 379, Short.MAX_VALUE)
        );
...
private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
    ...
    private void setBill(Rechnung bill) {
        this.curEinnahme = new Einnahme();
        jTextField6.setText(bill.getFDatum());

        Kunde c = new Kunde(bill.getKundenId());
