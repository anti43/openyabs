...
public class Setup extends javax.swing.JFrame implements Constants, Strings {
    ...
    public Setup() {
        ...
        try {
            jTextField1.setText(Main.settings.getDBPath());
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Es wurde keine Datenbank gefunden. \nDie Datenbank und benötigte Verzeichnisse werden nun erstellt.");
                    ...
                    .add(jPanel3Layout.createSequentialGroup()
                        ...
                        .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel3Layout.createSequentialGroup()
                                .add(jRadioButton3)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jTextField4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE))
                            .add(jRadioButton2)
                            .add(jRadioButton1)))
                    .add(jTextField1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        pdfpathtf.setBackground(new java.awt.Color(255, 255, 255));
        ...
        backuppathtf.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 515, Short.MAX_VALUE)
    ...
    private void install() {
        ...
        if (jCheckBox3.isSelected()) {
            ...
            if (jRadioButton1.isSelected()) {
                Main.settings.setDBDriver(ConnectionType.DERBY_DRIVER);
            } else if (jRadioButton2.isSelected()) {
                Main.settings.setDBDriver(ConnectionType.MYSQL_DRIVER);
