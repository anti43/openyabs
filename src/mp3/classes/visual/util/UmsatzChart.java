 ...
 * @author  anti43
 */
public class UmsatzChart extends javax.swing.JFrame {
    ...
    public UmsatzChart() {
        ...
        Data d = new Data(mp3.classes.layer.QueryClass.instanceOf());
           ...
           double str =d.fetchUmsatzInMonth2(months[i-1],Formater.formatYear(new Date()));
        ...
        LineGraph bar = new LineGraph("Umsatz " + Formater.formatYear(new Date()), 0, maxval+100);
        ...
        for (int i = 1; i <= months.length; i++) {
           ...
           double str =d.fetchUmsatzInMonth2(months[i-1],Formater.formatYear(new Date()));
            ...
            String string = months[i-1];
                ...
                bar.addItem(string+" (" + str +"Ä)",(int) str, color);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Data d = new Data(mp3.classes.layer.QueryClass.instanceOf());
           ...
           double str =d.fetchUmsatzInMonth2(months[i-1],jTextField1.getText());
        ...
        LineGraph bar = new LineGraph("Umsatz " + jTextField1.getText(), 0, maxval+100);
        Color color =Color.darkGray;
