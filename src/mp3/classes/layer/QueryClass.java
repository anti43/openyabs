 ...
 * @author anti
 */
public class QueryClass extends mp4.datenbank.verbindung.Query implements mp4.datenbank.struktur.Tabellen,Cloneable {
    ...
    public static void setProgressBarOn(JProgressBar mainProgress, mainframe main) {
