 ...
 * @author anti
 */
public class QueryClass extends Query implements Structure,Cloneable {
...
//    }
     ...
     * Singleton!
     */
    private QueryClass(String url) throws Exception {
        super(Conn.getConnection(url), TABLE_MYDATA);
    ...
    public static QueryClass instanceOf(String url){
    
    
        if(qc ==null) {
            try {
                qc = new QueryClass(url);
