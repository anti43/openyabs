 ...
 * @author anti43
 */
public class SKRKonto extends compat.mp3.Things implements compat.mp3.Structure{
    ...
    public SKRKonto() {
       super(QueryClass.instanceOf(ImportHelper.dbURL).clone(TABLE_KONTEN));
    }
    ...
    public SKRKonto(String id) {
        super(QueryClass.instanceOf(ImportHelper.dbURL).clone(Structure.TABLE_KONTEN));
    ...
    public void save() {
        ...
        if (id > 0) {
            ...
            compat.mp3.Popup.warn(java.util.ResourceBundle.getBundle("languages/Bundle").getString("no_data_to_save"), Popup.WARN);
    ...
    public String[][] getAll() {
        ...
        Query q = QueryClass.instanceOf(ImportHelper.dbURL).clone(TABLE_KONTEN);
