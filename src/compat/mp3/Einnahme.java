 ...
 * @author anti43
 */
public class Einnahme extends compat.mp3.Things implements compat.mp3.Structure, Daemonable{
...
//  "preis varchar(50) default NULL,"+"tax varchar(50) default NULL,"+"datum varchar(50) default NULL,"+
    ...
    public Einnahme() {
       super(QueryClass.instanceOf(ImportHelper.dbURL).clone(TABLE_INCOME));
    ...
    public String[][] getAll() {
        ...
        Query q = QueryClass.instanceOf(ImportHelper.dbURL).clone(TABLE_INCOME);
