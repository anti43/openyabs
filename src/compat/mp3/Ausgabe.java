 ...
 * @author anti43
 */
public class Ausgabe extends compat.mp3.Things implements  compat.mp3.Structure, compat.mp3.Daemonable{
...
//  "preis varchar(50) default NULL,"+"tax varchar(50) default NULL,"+"datum varchar(50) default NULL,"+
    ...
    public Ausgabe() {
       super(QueryClass.instanceOf(ImportHelper.dbURL).clone(TABLE_DUES));
    }
    ...
    public String[][] getAll() {
        ...
        Query q = QueryClass.instanceOf(ImportHelper.dbURL).clone(TABLE_DUES);
