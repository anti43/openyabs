 ...
 * @author anti43
 */
public class ProductGroupHandler extends compat.mp3.Things implements compat.mp3.Structure {
...
//    }
    ...
    public static ProductGroupHandler instanceOf() {
        ...
        if (g == null) {
            g = new ProductGroupHandler(QueryClass.instanceOf(ImportHelper.dbURL));
        }
