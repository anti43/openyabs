 ...
 * @author anti
 */
public class Manufacturer extends compat.mp3.People implements compat.mp3.Structure {
    ...
    public Manufacturer(Query query) {
        super(query.clone(TABLE_MANUFACTURER));
    }

    public Manufacturer(Query query, String id) {
        super(query.clone(TABLE_MANUFACTURER));
