 ...
 *  
 */
public class FileToTemplate extends DatabaseObject {

    private String description = "";
    private int templatesids;
    private String filename = "";
    private File file;

    public FileToTemplate() {
        context.setDbIdentity(Context.IDENTITY_FILES_TO_TEMPLATES);
    ...
    /**
     * @return the templatesids
     */
    public int __getTemplatesids() {
        return templatesids;
    }

    /**
     * @param templatesids the templatesids to set
     */
    public void setTemplatesids(int templatesids) {
