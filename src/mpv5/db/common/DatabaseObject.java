...
//                Log.Debug(DatabaseObject.class, "Using cached object " + context.getDbIdentity() + "@" + id + " [" + o + "]");
   ...
   /**
    * This can be used to graphically represent a do.<br/> The programmer has to
   ...
   /**
    * Convenience method: Returns all DO properties (getters) which would return
    * plain String values
    *
   ...
   /**
    * Locks the dataset represented by this do. The dataset can not be edited by
    * someone else after locking it, until the locking user has logged-out. This
    * does not prevent the data to be viewed by anyone.
    *
    * @return
    */
   public boolean lock() {
...
//                    Log.Debug(this, "Calling: " + methods[i]);
   ...
   /**
    * Injects this do into a Datapanel Each of the DataPanel's fields wich has a
    * name ending with underscore must match one of the fields in this do child
    * (without underscore)
    *
    ...
    * two-fields Object-Array. Example: new Object[]{"dateadded", java.util.Date
    * }
    */
...
//    }
   ...
   /**
    * Fills the return value's data (rows) into an array of dos if singleExplode
    * is false, if not fills target with the first row
    */
    ...
    * represent the same row of their table in the database.<br/> You should not
    * override this, and if, check for the Object to be an instanceOf your own
    * class.
    *
...
//            Object[] objects = a.get(i);
    ...
    * The ordering is somewhat unpredictable, however the array will always
    * start with [IDENTITY, ...]. A fieldcount below 2 is not allowed.
