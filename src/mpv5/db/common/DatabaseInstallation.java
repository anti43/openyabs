...
"CREATE TABLE productlistitems (IDS BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), description VARCHAR(2500), cname VARCHAR(500), groupsids BIGINT  REFERENCES groups(ids) DEFAULT 1, productsids BIGINT REFERENCES products(ids) ON DELETE CASCADE, dateadded DATE NOT NULL,intaddedby BIGINT DEFAULT 0,invisible SMALLINT DEFAULT 0,reserve1 VARCHAR(500) DEFAULT NULL, reserve2 VARCHAR(500) DEFAULT NULL, PRIMARY KEY  (ids))",
