...
public class wizard_DBSettings_manage_1 extends javax.swing.JPanel implements Wizardable {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("wizard_DBSettings_manage_1.jPanel1.border.title"))); // NOI18N
        jPanel1.setName("jPanel1"); // NOI18N

        labeledTextChooser2.set_Label(bundle.getString("wizard_DBSettings_manage_1.labeledTextChooser2._Label")); // NOI18N
        labeledTextChooser2.setName("labeledTextChooser2"); // NOI18N

        jCheckBox3.setText(bundle.getString("wizard_DBSettings_manage_1.jCheckBox3.text")); // NOI18N
        ...
        labeledTextField1.set_Label(bundle.getString("wizard_DBSettings_manage_1.labeledTextField1._Label")); // NOI18N
        labeledTextField1.set_Text(bundle.getString("wizard_DBSettings_manage_1.labeledTextField1._Text")); // NOI18N
        labeledTextField1.setEnabled(false);
        labeledTextField1.setName("labeledTextField1"); // NOI18N

        labeledTextField2.set_Label(bundle.getString("wizard_DBSettings_manage_1.labeledTextField2._Label")); // NOI18N
        labeledTextField2.setEnabled(false);
        labeledTextField2.setName("labeledTextField2"); // NOI18N

        jLabel3.setText(bundle.getString("wizard_DBSettings_manage_1.jLabel3.text")); // NOI18N
