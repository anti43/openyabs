...
//        jSplitPane2.setDividerLocation((User.getCurrentUser().getProperties().getProperty("org.openyabs.uiproperty.itempanel.divider2.dividerLocation", -1)));
    ...
    private void setEnddate(Contact dbo) {
        if (User.getCurrentUser().getProperties().getProperty("org.openyabs.itemproperty", "calcenddate")
            ...
            try {
                if (dbo != null) {
                    int payterm = dbo.__getPayterm() == 0 ? Integer.valueOf(User.getCurrentUser().getProperties().getProperty("bills.warn.days"))
                            : dbo.__getPayterm();
...
//        Popup.notice(Messages.SELECT_A_CONTACT);
    ...
    private void initComponents() {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(type, javax.swing.GroupLayout.DEFAULT_SIZE, 1098, Short.MAX_VALUE)
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(button_compare, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(button_references, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel12Layout.createSequentialGroup()
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jPanel9, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1360, Short.MAX_VALUE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addComponent(itemPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
        );
    ...
    private void button_compareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_compareActionPerformed
        if (this.reforderids_ != null && this.reforderids_ > 0) {
            ...
            try {
                DatabaseObject dob = DatabaseObject.getObject(Context.getOrder(), this.reforderids_);
                ...
                try {
                    ArrayList<Item> data2 = DatabaseObject.getObjects(Context.getInvoice(), new QueryCriteria("reforderids", dataOwner.__getRefOrderIDS()));
                ...
                try {
                    ArrayList<Item> data3 = DatabaseObject.getObjects(Context.getPartPayment(), new QueryCriteria("reforderids", dataOwner.__getRefOrderIDS()));
        ...
        try {
            ...
            if (Popup.Y_N_dialog(Messages.ActivityList_Existing.toString())) {
                ...
                while (it.hasNext()) {
                    ...
                    s.setOrdernr(model.getRowCount());
                    s.setItemsids(i2.__getIDS());
                    model.insertRow(model.getRowCount(), s.getRowData(model.getRowCount()));
                }
            }
        } catch (NodataFoundException ex) {
            Log.Debug(this, ex.getMessage());
