            ...
            for (int i = 0; i < d.length; i++) {
                ...
                if (null != Integer.valueOf(data[i][11].toString())) {
                    switch (Integer.valueOf(data[i][11].toString())) {
                        case Item.STATUS_PAID:
                            if (Integer.valueOf(data[i][10].toString()) == Item.TYPE_CREDIT) {
                                ...
                                revenuetax -= taxVal;
                                d[i][15] = "<html><p align=center>" +FormatNumber.formatDezimal(-1 * netVolume);
                            } else {
                                revenuenet += netVolume;
                                revenuetax += taxVal;
                                d[i][15] = "<html><p align=center>" + FormatNumber.formatDezimal(netVolume);
                            }
                            break;
                        case 1000:
                        d[i][15] = "<html><p align=center>" + FormatNumber.formatDezimal(-1 * netVolume);
                    ...
                    case 2000:
                        ...
                        break;
                    default:
                        d[i][15] = "<html><p align=center>" + FormatNumber.formatDezimal(0d);
                        break;
                }
                }
                d[i][12] = "<html><p align=center>" + FormatNumber.formatDezimal(netVolume);
                d[i][13] = "<html><p align=center>" + FormatNumber.formatDezimal(taxVal);
                d[i][14] = "<html><p align=center>" + FormatNumber.formatDezimal(brutVolume);
                d[i][16] = "<html><p align=center>" + FormatNumber.formatDezimal(discountVolume);
...
//                        additional = false;
                    ...
                    try {
                        ...
                        for (int i = 0; i < d3.length; i++) {
                            es[i] = DatabaseObject.getObject(Context.getInvoice(), Integer.valueOf(d3[i][0].toString()));
                        }
                    ...
                    try {
                        ...
                        for (int i = 0; i < d4.length; i++) {
                            es[i] = DatabaseObject.getObject(Context.getInvoice(), Integer.valueOf(d4[i][0].toString()));
                        }
                    ...
                    try {
                        ...
                        for (int i = 0; i < d5.length; i++) {
                            es[i] = DatabaseObject.getObject(Context.getInvoice(), Integer.valueOf(d5[i][0].toString()));
                        }
