 ...
 */
public class ObjectsMonthChooser extends JPanel implements ItemListener,
        ChangeListener {
    ...
    private ObjectsCalendarDayChooser dayChooser;
    private ObjectsYearChooser yearChooser;
     ...
     */
    public ObjectsMonthChooser(boolean hasSpinner) {
        super();
        ...
        if (hasSpinner) {
            spinner = new JSpinner() {
                ...
                public Dimension getPreferredSize() {
                    ...
                    return new Dimension(size.width + 15, textField.getPreferredSize().height);
                }
            };
     ...
     *            the day chooser
     */
    public void setDayChooser(ObjectsCalendarDayChooser dayChooser) {
     ...
     */
    public void setYearChooser(ObjectsYearChooser yearChooser) {
    ...
    public static void main(String[] s) {
        ...
        frame.getContentPane().add(new ObjectsMonthChooser());
        frame.pack();
