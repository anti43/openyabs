...
//    private String old_cnumber = "";
    ...
    private void itemTableClicked(MouseEvent evt) {
        if (evt.getButton() == MouseEvent.BUTTON1 && evt.getClickCount() > 1) {
            try {
                mpv5.YabsViewProxy.instance().getIdentifierView().addTab(DatabaseObject.getObject(dataTableContext, Integer.valueOf(dataTable.getModel().getValueAt(dataTable.convertRowIndexToModel(dataTable.getSelectedRow()), 0).toString())));
            } catch (NodataFoundException ex) {
                Log.Debug(ex);
            }
    ...
    private void initComponents() {
        ...
        title.setMaximumSize(new java.awt.Dimension(150, 24));
        title.setMinimumSize(new java.awt.Dimension(120, 21));
        title.setName("title"); // NOI18N
        title.setPreferredSize(new java.awt.Dimension(150, 24));
        ...
        cname.setMaximumSize(new java.awt.Dimension(150, 24));
        cname.setMinimumSize(new java.awt.Dimension(120, 21));
        cname.setName("cname"); // NOI18N
        cname.setPreferredSize(new java.awt.Dimension(150, 24));

        prename.set_Label(bundle.getString("ContactPanel.prename._Label")); // NOI18N
        prename.setMaximumSize(new java.awt.Dimension(150, 24));
        prename.setMinimumSize(new java.awt.Dimension(120, 21));
        prename.setName("prename"); // NOI18N
        prename.setPreferredSize(new java.awt.Dimension(150, 24));
        ...
        department.setMaximumSize(new java.awt.Dimension(150, 24));
        department.setMinimumSize(new java.awt.Dimension(120, 21));
        department.setName("department"); // NOI18N
        department.setPreferredSize(new java.awt.Dimension(150, 24));
        ...
        displayname.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        mainaddressLayout.setHorizontalGroup(
            ...
            .addGroup(mainaddressLayout.createSequentialGroup()
                ...
                .addGroup(mainaddressLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(mainaddressLayout.createSequentialGroup()
                        .addGroup(mainaddressLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, mainaddressLayout.createSequentialGroup()
                                .addComponent(title, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(prename, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(mainaddressLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cname, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(mainaddressLayout.createSequentialGroup()
                        .addGroup(mainaddressLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(mainaddressLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(countryselect, 0, 0, Short.MAX_VALUE))
        ...
        button_credits.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        button_credits.setMaximumSize(new java.awt.Dimension(120, 29));
        button_credits.setName("button_credits"); // NOI18N
        button_credits.setPreferredSize(new java.awt.Dimension(100, 29));
        button_credits.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        button_credits.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_creditsActionPerformed(evt);
            }
        });
        jToolBar3.add(button_credits);

        jSeparator5.setName("jSeparator5"); // NOI18N
        jSeparator5.setPreferredSize(new java.awt.Dimension(10, 1));
        jSeparator5.setSeparatorSize(new java.awt.Dimension(10, 1));
        ...
        jSeparator6.setSeparatorSize(new java.awt.Dimension(10, 1));
        ...
        filterme.setMaximumSize(new java.awt.Dimension(250, 24));
        ...
        jToolBar1.setPreferredSize(new java.awt.Dimension(0, 40));

        button_offer.setFont(button_offer.getFont());
        ...
        button_order.setFont(button_order.getFont());
...
//        isCompany(company.isSelected());
    ...
    private void button_billsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_billsActionPerformed
        ...
        dataTableContext = Context.getInvoice();
//        c.addReference(Context.getContact().getDbIdentity(), "cname", "filename");
        Object[][] data = new DatabaseSearch(dataTableContext).getValuesFor(Context.DEFAULT_ITEM_SEARCH, "contactsids", dataOwner.__getIDS());
        ...
        button_offers.setSelected(false);
        button_bills.setSelected(true);
        button_orders.setSelected(false);
        button_activitylists.setSelected(false);
        button_credits.setSelected(false);
        button_products.setSelected(false);
    ...
    private void button_offersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_offersActionPerformed
        dataTableContext = Context.getOffer();
        ...
        button_offers.setSelected(true);
        button_bills.setSelected(false);
        button_orders.setSelected(false);
        button_activitylists.setSelected(false);
        button_credits.setSelected(false);
        button_products.setSelected(false);
    ...
    private void button_ordersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_ordersActionPerformed
        dataTableContext = Context.getOrder();
        ...
        button_offers.setSelected(false);
        button_bills.setSelected(false);
        button_orders.setSelected(true);
        button_activitylists.setSelected(false);
        button_credits.setSelected(false);
        button_products.setSelected(false);
    ...
    private void button_productsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_productsActionPerformed
        ...
        button_activitylists.setSelected(false);
        button_credits.setSelected(false);
        button_products.setSelected(true);
    ...
    private void button_activitylistsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_activitylistsActionPerformed
        ...
        button_bills.setSelected(false);
        button_orders.setSelected(false);
        button_activitylists.setSelected(true);
        button_credits.setSelected(false);
    ...
    private void button_creditsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_creditsActionPerformed
        dataTableContext = Context.getCredit();
        ...
        button_orders.setSelected(false);
        button_activitylists.setSelected(false);
        button_credits.setSelected(true);
        button_products.setSelected(false);
...
//        old_cnumber = cnumber_;
    ...
    public void isCustomer(boolean b) {
        ...
        button_offer.setVisible(b);
        button_bill.setVisible(b);
        button_order.setVisible(b);
        button_credit.setVisible(b);

        button_offers.setVisible(b);
        button_bills.setVisible(b);
        button_orders.setVisible(b);
        button_activitylists.setVisible(b);
        button_credits.setVisible(b);
    ...
    public void isManufacturer(boolean b) {
        ...
        button_product.setVisible(b);
        button_products.setVisible(b);
