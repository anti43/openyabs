...
public interface Constants {
     ...
     * Full Version number
     */
    public static final String VERSION = "Yabs-1.3.1";//ATTENTION: when changing this, add language and template file to resources/extra folder for the new version!
