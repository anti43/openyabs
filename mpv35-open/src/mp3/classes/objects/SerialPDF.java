...
public class SerialPDF {
     ...
     * @param named 
     */
    public SerialPDF(Customer c, File template, String pretext, String text, boolean named) {
        try {
    ...
    public void printOutFieldNames() {
        ...
        for (Iterator fieldNames = fieldNameKeys.iterator(); fieldNames.hasNext();) {
            try {
                ...
                Logger.getLogger(SerialPDF.class.getName()).log(Level.SEVERE, null, ex);
            } catch (DocumentException ex) {
                Logger.getLogger(SerialPDF.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
