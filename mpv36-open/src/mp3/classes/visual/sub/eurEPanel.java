...
public class eurEPanel extends javax.swing.JPanel {
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if(this.curEinnahme!=null  && curEinnahme.id > 0) {
            ...
            curEinnahme.setPreis(jTextField4.getText());
            curEinnahme.setTax(jTextField3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        new Einnahme(curKonto.getId(),jEditorPane1.getText(), jTextField4.getText(), jTextField3.getText(), Formater.getDate(jTextField6.getText()));
        updateTableData();
