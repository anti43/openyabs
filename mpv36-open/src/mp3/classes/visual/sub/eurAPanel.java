...
import mp3.classes.visual.main.konten;
...
public class eurAPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 752, Short.MAX_VALUE)
        );
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            id = Integer.valueOf((String) jTable1.getValueAt(jTable1.getSelectedRow(), 1));
        ...
        if (idOk) {
            ...
            this.setAusgabe(new Ausgabe(QueryClass.instanceOf(), id.toString()));
        }
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if (this.curAusgabe != null && curAusgabe.id > 0) {
            ...
            curAusgabe.setPreis(jTextField4.getText());
            curAusgabe.setTax(jTextField3.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        new Ausgabe(curKonto.getId(), jEditorPane1.getText(), jTextField4.getText(), jTextField3.getText(), Formater.getDate(jTextField6.getText()));
        updateTableData();
