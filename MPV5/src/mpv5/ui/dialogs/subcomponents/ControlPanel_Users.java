 ...
 * @author anti43
 */
public class ControlPanel_Users extends javax.swing.JPanel implements ControlApplet {
    ...
    private void initComponents() {
        ...
        proxy.setText(bundle.getString("ControlPanel_Users.proxy.text")); // NOI18N
        proxy.setName("proxy"); // NOI18N

        jLabel2.setText(bundle.getString("ControlPanel_Users.jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N

        port.setText(bundle.getString("ControlPanel_Users.port.text")); // NOI18N
        ...
        auth.setText(bundle.getString("ControlPanel_Users.auth.text")); // NOI18N
        ...
        user.setText(bundle.getString("ControlPanel_Users.user.text")); // NOI18N
