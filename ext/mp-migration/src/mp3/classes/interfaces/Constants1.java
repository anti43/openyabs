...
public interface Constants1 {
     ...
     * Version info
     */
    public static String VERSION = "3.62";
    public static String TITLE = "[DB CHECK]";
     ...
     */
    public static final String DATABASEPATH = Constants1.HOME + File.separator +".mp" ;
    
    /**
     * Full path to settings file 
     */
    public static String SETTINGS  = Constants1.HOME + File.separator +".mp" + File.separator + "settings36.mp";
